    ...
    <main class="dashboard d-flex">
        ...
        <div class="container-fluid px">
            ...
            <div class="button-add-student">
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">Add EQUIPMENT</button>
            ...
            <div class="table table-responsive">
                <table class="table table-striped table-borderless">
                    ...
                    <tbody>
                        ...
                        <?php
                        $requete = "SELECT * FROM 	EQUIPMENTS";
